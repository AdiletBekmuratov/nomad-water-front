...
import { Card } from './CardBottle';

export const Main = () => {
  return (
    <div className={`w-full bg-bg-crm `}>
      <div className={`flex items-center py-4 px-10 bg-white`}>
      ...
      <div className={`px-6 text-xs`}>
        ...
        <div className={`grid gap-x-4 gap-y-6 pt-6 mb-8 grid-cols-2 md:grid-cols-1`}>
          <Card />
          <Card />
          <Card />
          <Card />
      ...
      <div className={`bg-white px-12 pt-5 pb-8 flex items-center justify-between`}>
        <a href="/" className={`cursor-pointer`}>
          <svg
            width="24"
            height="24"
