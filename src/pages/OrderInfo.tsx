    ...
    <>
      ...
      <div className="container mt-6">
        ...
        <Card className="w-11/12 mx-auto mt-4 flex items-center justify-between m-5">
          <div className="">
            <h3 className="font-semibold font-montserrat text-sm text-dark-blue">Способ оплаты</h3>
        ...
        <Modal
          ...
          openButtonStyle="bg-transparent text-red-600 font-semibold font-montserrat ">
          <div className="my-4">
            <Checkbox
